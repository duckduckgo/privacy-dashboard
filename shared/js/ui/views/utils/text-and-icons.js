...
export const text = {
    ...
    'hero blocked': () => 'The following third-party domains’ requests were blocked from loading because they were identified as tracking requests. If a company\'s requests are loaded, it can allow them to profile you.',
    'hero trackers not blocked': () => 'No tracking requests were blocked from loading on this page. If a company\'s requests are loaded, it can allow them to profile you.',
    'hero thirdparties loaded': () => 'The following third-party domains’ requests were loaded. If a company\'s requests are loaded, it can allow them to profile you, though our other web tracking protections still apply.',
    'hero not blocked protections off': () => 'No tracking requests were blocked from loading because Protections are turned protectionsOff for this site. If a company\'s requests are loaded, it can allow them to profile you.',
    'hero third parties protections off': () => 'The following third-party domains’ requests were loaded because Protections are turned protectionsOff for this site. If a company\'s requests are loaded, it can allow them to profile you, though our other web tracking protections still apply.'
}
export const icons = {
    large: {
